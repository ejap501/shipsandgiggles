...
public class CollegeTestsGoodricke {
    ...
    public void testDamageCollege(){
        ...
        GoodrickeCollege college = new GoodrickeCollege(texture,location,maximumHealth,new World(new Vector2(0, 0), false));
        college.damage(10);
    ...
    public void testDestroyCollege(){
        ...
        GoodrickeCollege college = new GoodrickeCollege(texture,location,maximumHealth,world);
        college.damage(2);
    ...
    public void CollegeHealthBarColour(){
        ...
        Sprite GoodrickeCollegeSprite = new Sprite(new Texture("models/alcuin_castle.png"));
        Location location = new Location(100f,100f);
        float maximumHealth = 100;
        World world = new World(new Vector2(0, 0), false);

        GoodrickeCollege college = new GoodrickeCollege(GoodrickeCollegeSprite,location,maximumHealth,world);
        college.damage(20);
    ...
    public void CollegeShootNoContact(){
        ...
        GoodrickeCollege college = new GoodrickeCollege(GoodrickeCollegeSprite,new Location(10000f,10000f),maximumHealth,world);
        college.shootPlayer(ship);
        assertEquals(0,BallsManager.listOfBalls.size());
