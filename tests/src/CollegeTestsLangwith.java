...
public class CollegeTestsLangwith {
    ...
    public void testDamageCollege(){
        ...
        LangwithCollege college = new LangwithCollege(texture,location,maximumHealth,new World(new Vector2(0, 0), false));
        college.damage(10);
    ...
    public void CollegeShootNoContact(){
        ...
        LangwithCollege college = new LangwithCollege(LangwithCollegeSprite,new Location(10000f,10000f),maximumHealth,world);
        college.shootPlayer(ship);
        assertEquals(0,BallsManager.listOfBalls.size());
